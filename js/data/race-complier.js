...
var booDash15 = new race("Boo Dash", "2015-10-03", "r5k", "Wild Waves Theme Park ", "Federal Way, WA", "American Cancer Society", "http://www.eventbrite.com/e/boo-dash-at-wild-waves-tickets-17877030680", "", "", "Halloween");
...
var mugsAndPugs15 =new race("Mugs and Pugs", "2015-10-03", "r5k",  "Graham-Kapowsin High School", "Graham, WA", "rainierfamilypt", "http://rainierfamilypt.com/mugsandpugs/", "", "", "");
	mugsAndPugs15.addRace("5k Adult", "11am", "", ["$30"], [""]);
	mugsAndPugs15.addRace("5k Youth Ages 18 & Under", "11am", "", ["$20"], [""]);
	raceArr.push(mugsAndPugs15);

var pdxMarathon15= new race("Portland Maratahon", "2015-10-04", "full", "SW 4th and Taylor", "Portland, OR", "Portland Marathon", "http://portlandmarathon.org/", "", "No", "");
...
var eugeneRaceForTheCure15 = new race("Race for the Cure", "2015-10-04", "r5k", "Valley River Center", "Eugene, OR", "Susan G. Komen Foundation", "http://race.komenoregon.org/site/TR?fr_id=1281&pg=entry", "", "", "");
...
var stepsToSafety15 = new race("Steps to Safety", "2015-10-10", "r10k", "Department of Public Safety: Standards and Training", "Salem, OR", "Eclectic Edge Racing", "http://www.mcdvcouncil.org/home.html", "", "", "");
...
var crabFest15 = new race("CrabFest 5k", "2015-10-10", "r5k", "Dungeness Crab & Seafood Festival", "Sequim, WA", "http://www.crabfestival.org/crab-fest-5k-runwalkscuttle/", "", "", "");
...
var monsterDash15 = new race("Monster Dash", "2015-10-10", "r10k", "Columbia View Park", "St Helens, OR", "Rotary Club of Columbia County", "http://www.sthelensmonsterdash.com/", "", "no", "Halloween/Run for Your Life/Zombies");
...
var girlfriends15 = new race("Girlfriends Run for a Cure Half & Quater Marathon", "2015-10-11", "half", "Northwest Personal Training 1011 Broadway", "Vancouver, WA", "Why Racing Events", "http://whyracingevents.com/event/693/" , "", "yes", "");
...
var greatColumbiaCrossing15 = new race("The Great Columbia Crossing","2015-10-11","r10k", "Dismal Nitch, WA", "Astoria, OR", "Astoria Warrenton Area Chamber of Commerce","http://www.greatcolumbiacrossing.com/","3,500","yes","");
...
var stageCoach15 = new race("Stagecoach Run", "2015-10-17", "r10k", "Oregon St. and West D St.", "Jacksonville, OR", "Southern Oregon Runners", "https://secure.getmeregistered.com/get_information.php?event_id=122284", "", "", "");
...
var bayToBrews15 = new race("Bays to Brews", "2015-10-17", "half","Rogue Ales & Spirits", "Newport, OR", "Run with Palua Events", "http://runwithpaula.com/bay-to-brews-half-marathon-10k/", "", "", "");
...
var  lakePaddenTrailHalf15 = new race("Lake Padden Trail Half Marathon", "2015-10-17", "half", "Lake Padden Park East Entrance",  "Bellingham, WA", "Lake Padden Trail Half", "http://www.lakepaddentrailhalf.org/", "", "", "");
...
var dawgDash15 = new race("Dawg Dash", "2015-10-18", "r10k","Red Square on UW Campus", "Seattle, WA", "University of Washington", "http://depts.washington.edu/alumni/blogs/dawgdash/races/seattle/", "", "yes", "");
...
var sekaniTrailRun15 = new race ("Sekani Trail Run", "2015-10-18",  "r10k","Camp Sekani Park", "Spokane, WA", "Sekani Trail Run", "http://sekanitrailrun.com/", "", "", "Trail Run");
...
var Charity15 = new race("4k 4Charity Fun Run", "2015-10-21", "", "Waterfront Park, West End of Hawthorne Bridge", "Portland, OR", "Energy Events", "http://4k4charity.com/run/pdx/", "", "", "");
...
var dirtyDuck15 = new race("Dirty Duck", "2015-10-24", "r5k", "University of Oregon", "Eugene, OR","Dirty Duck",  "http://dirtyduck5k.com/", "2,500",  "", "feather & color run");
...
var happyGirlsSisters15 = new race("Happy Girls Run – Sisters", "2015-10-24", "half", "Five Pine Lodge Campus", "Sisters, OR", "Lay It Out Events", "http://happygirlsrunsisters.com/race-info/event-schedule/", "", "", "trail run \(half only\)");
...
var columbiaGorge15 = new race("Columbia Gorge Marathon & Half", "2015-10-25", "full", "Mark O. Hatfield West Trailhead", "Hood River, OR", "Breakaway Promotions LLC", "http://www.columbiagorgemarathon.com/", "1500", "yes", ""); 
...
var runLikeHell15 = new race("Run Like Hell", "2015-10-25", "half", "Pioneer Courthouse Square", "Portland, OR", "Terrapin Events", "http://terrapinevents.com/event/run-like-hell-portland-half-marathon/", 5000, "Yes", "Halloween/Under the Big Top" );
...
var ashlandMonsterDash15 = new race("Monster Dash", "2015-10-31", "r10k", "Ashland Schools Foundation", "Ashland, OR",  "http://www.ashlandmonsterdash.com/", "", "", "", "Halloween");
...
var zombieMudRun15 = new race("Zombie Mud Run", "2015-10-31", "", "Wildhorse Shelter at Community Park West", "Pendleton, OR", "Pendleton Parks & Recreation", "http://www.active.com/pendleton-or/running/zombie-mud-run-2015?cmp=39-34-156210&ltcmp=254301&ltclickid=10_24722494_620176de-e6e5-4309-8d05-fb2dd326e6ed&cmp=39-34", "", "", "Mud Run/Zombies/Halloween");
	zombieMudRun15.addRace("3k", "8am", "", ["$15"], [""]);
	raceArr.push(zombieMudRun15);

//November 2015 Races

var purpleStride15 = new race("PurpleStride Puget Sound", "2015-11-01", "r5k", "Magnuson Park - Hangar 30", "Seattle, WA", "Pancreatic Cancer Action Network", "http://purplestride.kintera.org/faf/home/default.asp?ievent=1136780&lis=1&kntae1136780=1F3F5806E8AC432DA54E18145E426A6C", "", "", "");
...
var battleToThePacific15 = new race("Battle to the Pacific", "2015-11-01", "half", "Fort Stevens State Park: Coffenbury Lake picnic area A",  "Hammond, OR", "Ascherl Industries", "http://www.ascherlindustries.com/pacificrun/index.html", "150", "", "");
...
var lithiaLoop15 = new race("Lithia Loop Trail Marathon", "2015-11-07", "full", "Lithia Park", "Ashland, OR", "Rouge Valley Runners", "http://www.roguevalleyrunners.com/LLTM/index.html", "300", "", "Trail Run");
	
	lithiaLoop15.addRace("Full", "8am", "6hrs", ["Before 10/21: $65", "Race Day Entry: $80 - no shirt"], ["shirt", "food", "drinks"]);
	raceArr.push(lithiaLoop15);

var sugarRush15 = new race("Sugar Rush", "2015-11-07", "r10k", "Gonzaga University Campus: McCarthey Athletic Center", "Spokane, WA", "RedPodium", "https://inlandnwbaby.webconnex.com/sugarrushspo15", "", "", "candy");
...
var runWithTheDuck15 = new race ("Run with the Duck", "2015-11-08", "r5k", "Riverfront Field - south side of Autzen Footbridge", "Eugene, OR", "University of Oregon: Healthy Oregon", "http://healthyoregon.uoregon.edu/Events/duckrun.aspx?q=DuckRun", "500", "", "");
...
var seaMustache15 = new race("Mustache Dash - Seattle", "2015-11-08", "r5k", "Magnuson Park", "Seattle, WA", "Mustache Dash", "http://mustachedache.com/seattle/", "", "", "Mustaches");
...
var pdxMustache15 = new race("Mustache Dash - Portland", "2015-11-14", "r5k", "Big Al's", "Beaverton, OR", "Mustache Dash", "http://mustachedache.com/portland/", "", "", "Mustaches");
...
var eolaHillsWineCellarsHarvest15 = new race("Eola Hills Wine Cellars Harvest Run", "2015-11-14", "r10k", "Eola Hills Wine Cellars", "Rickreall, OR", "RunSignUp", "https://runsignup.com/Race/OR/Rickreall/nohills?", "", "", "");
...
var pdxVetsDay15= new race("National Veterans Day Run - Portland", "2015-11-15", "r5k", "Mt. Tabor", "Portland, OR", "National Veterans Day Run", "http://www.veteransdayrun.com/register/portland", "", "", "Veterans Day");
...
var flyingHawaiian15 = new race("Flyin' Hawaiian", "2015-11-15", "r5k", "Camp Harlow", "Eugene, OR", "Eclectic Edge Events", "http://www.eclecticedgeracing.com/Flyin__Hawaiian_5K.html", "", "", "Hawaiian");
...
var beaverBowl15 = new race("Beaver Bowl 5k", "2015-11-21", "r5k", "OSU Campus Women’s Building", "Corvallis, OR", "OSU College of Public Health and Human Sciences", "http://www.eventbrite.com/e/beaver-bowl-5k-and-kids-fun-run-tickets-16323587289", "", "", "Football / OSU Beavers");
...
var girlsOnTheRun15 = new race("Girls on the Run", "2015-11-21", "r5k", "Bloedel Donovan", "Bellingham, WA", "WHATCOM Family YMCA", "http://www.whatcomymca.org/gotr-5k.html", "", "", "");
...
var redmondTurkeyTrot15 = new race("Redmond Turkey Trot", "2015-11-21", "r5k", "Redmond Town Center", "Bellingham, WA", "Snohomish Running Company", "http://redmondturkeytrot.com/", "", "", "Thanksgiving");
...
var ducksVsBeavers15 = new race("Ducks vs Beavers Rivalry Clash", "2015-11-22", "r10k", "Portland, International Raceway", "Portland, OR", "Rivalry Clash Events", "http://www.rivalryclash.com/event/details/portland/", "", "yes", "UO Ducks & OSU Beavers");
...
var runToStayWarm15 = new race("EWEB Run to Stay Warm", "2015-11-22", "half", "Eugene Water & Electric Board",  "Eugene, OR",  "http://www.eweb.org/runtostaywarm", "", "", "");
...
var keizerTurkeyDash15 = new race("Keizer’s Turkey Dash Fun Run", "2015-11-26", "r5k", "Lowe’s Home Improvement", "Keizer, OR", "Kiezer Chamber of Commerce", "http://chambermaster.keizerchamber.com/events/details/keizer-s-turkey-dash-5k-fun-run-walk-presented-by-salem-real-estate-group-11-26-2015-7965" , "1200", "", "Thanksgiving");
...
var turkeyTrotZoo15 = new race("Turkey Trot at the Zoo", "2015-11-26", "r5k", "Oregon Zoo", "Keizer, OR", "Oregon Road Runner’s Club", "http://orrc.net/events/event-list/turkey-trot-4-mile-run-and-walk-with-kids-tot-trot/", "3500", "yes", "Thanksgiving");
...
var tofurkyTrot15 = new race("Tofurky Trot", "2015-11-26", "r5k", "Oaks Park Spring Water Trail", "Portland, OR", "The Tofurky Company", "http://www.eventbrite.com/e/tofurky-trot-2015-in-pdx-tickets-15023191771?aff=erelexporg" , "", "", "Thanksgiving");
...
var seattleGhostMar15 = new race("Seattle Ghost Marahton", "2015-11-28", "ultra", "Mt. Baker Park", "Seattle, WA", "Databar Events", "https://www.databarevents.com/seattleghost", "400", "", "");
...
var hotButteredRun15 = new race ("Hot Buttered Run", "2015-11-29", "half", "Esther Short Park", "Vancouver, WA", "Engery Events", "http://energyevents.com/hotbutteredrun", "", "", "", "Winter Holidays");
...
var jingleBellRock15 = new race("Jingle Bell Rock", "2015-12-05", "r5k", "Fort Steilacoom Park", "Lakewood, WA", "City of Lakewood", "http://www.active.com/lakewood-wa/running/distance-running-races/jingle-bell-rock-5k-fun-run-2015?cmp=39-34&ltclickid=10_72218924_41293a1a-c0c6-42a8-9cf8-6b1400a71bcf&ltcmp=254301", "" , "", "Winter Holidays");
	jingleBellRock15.addRace("5k *dog friendly event*", "10am", "", ["$0"], ["shirt ", "bells ", "swag bag " , "s'mores ", "cider"]);
	raceArr.push(jingleBellRock15);


var blerchGreenLake15 = new race("Beat the Blerch Green Lake Fun Run", "2015-12-05", "r10k", "Green Lake Park", "Seattle, WA","The Oatmeal", "https://www.eventbrite.com/e/beat-the-blerch-green-lake-fun-run-registration-19071281717", "", "", "blerch/winter holidays" );
...
var hoHo15 = new race("Ho Ho 5k", "2015-12-06", "r5k", "Cook Park", "Tigard, OR", "X-Dog Events", "http://www.xdogevents.com/hoho.html", "", "", "Winter Holidays");
...
var jingleBellPDX15 = new race("Jingle Bell 5k", "2015-12-06", "r5k", "World Trade Center", "Portland, OR", "The Arthritis, Foundation", "http://www.jbr.org/faf/home/default.asp?ievent=1138292", "", "", "Winter Holidays" );	
...
var holidayHustle15 = new race("Holiday Hustle", "2015-12-12", "r5k", "Twin Peaks Park", "Central Point, OR", "Junior League of Jackson County", "https://secure.getmeregistered.com/get_information.php?event_id=122692", "", "", "Winter Holidays");
	holidayHustle15.addRace("5k Adult", "5pm", "", ["$20"], [""]);
	holidayHustle15.addRace("5k Kids: Ages 12 & Under", "5pm", "", ["$10"], [""]);
	raceArr.push(holidayHustle15);

var santaRunsTacoma15 = new race("Santa Runs Tacoma", "2015-12-12", "half", "State Farm Building", "Tacoma, WA", "Tacoma City Marathon Association", "http://santarunstacoma.com/", "1000 for the Half", "yes", "Winter Holidays");
...
var naughtyOrNice15 = new race("Naughty or Niceathon", "2015-12-12", "r5k", "Big Al's", "Beaverton, OR", "Uberthons", "http://www.uberthons.com/naughtyorniceathon", "Yes. But only with a ratio of 51% Nice people and 49% Naughty people.", "No","Winter Holidays");
	naughtyOrNice15.addRace("5k Choose Naught or Nice", "9:00am", "", ["$30"], [
	...
	naughtyOrNice15.addRace("Kidathon 1/4-1/2 Mile", "10:30am", "", [""], ["uberkids medal avalible for $10"]);
	naughtyOrNice15.addRace("Kids 1 Miler: 12 and under (timed)", "10:30am", "", ["$10"], ["kid's medal"]);
	raceArr.push(naughtyOrNice15);

var holidayHalf15 = new race("Holiday Half & 5k", "2015-12-13", "half", "Addias North America Campus", "Portland, OR", "Foot Traffic", "http://foottraffic.us/the-races/holiday/", "", "", "Winter Holidays");
...
var eugeneHolidayHalf15 = new race("Eugene Holiday Half & Hustle", "2015-12-19", "half", "Lane Events Center", "Eugene, OR", "Pink Buffalo Racing", "http://www.eugeneholidayhalf.com/Home.html", "", "", "Winter Holidays");
...
var medfordUglySweater15 = new race(
	"Medford Ugly Sweater 5k", "2015-12-19", "r5k", "Main St & S Bartlett St (Near RCC)", "Medford, OR", "Medford Ugly Sweater Run", "http://www.medforduglysweater5k.com/index2.php", "", "", "Winter Holidays");
...
var yukonDoit15 = new race("Yukon Do it Marathon & Half Marathon", "2015-12-27", "full", "Totem Pole by the Downtown Library", "Port Orchard, WA", "Databar Events", "http://www.databarevents.com/events/view/74", "", "", "");
...
var lastChance15 = new race("Last Chance Marathon", "2015-12-31", "full", "Fairhaven Park", "Bellingham, WA", "Databar Events", "http://www.databarevents.com/events/view/72", "250", "yes", "New Year's Eve");
...
var firstRun15 = new race("First Run", "2015-12-31","r10k", "World Trade Center", "Portland, OR", "AA Sports", "http://aasportsltd.com/events/race/first-run-walk/", "", "", "New Year's Eve");
