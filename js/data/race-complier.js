...
var pdxMarathon= new race("Portland Maratahon", "2015-10-04", "Portland, OR", "SW 4th and Taylor", "Portland Marathon", "http://portlandmarathon.org/", "", "No", "TBD", "None");
...
var runLikeHell = new race("Run Like Hell", "2015-10-25", "Portland, OR", "Pioneer Courthouse Square", "Terrapin Events", "http://terrapinevents.com/event/run-like-hell-portland-half-marathon/", 5000, "Yes", "Halloween/Under the Big Top" );
...
// var name = new race(title, startLocation, date, city, organizer, orgLink, cap, bagCheck, theme);
