...
// //1
var pdxMarathon15= new race("Portland Maratahon",  1, "full", "2015-10-04", 1, "Portland, OR", "SW 4th and Taylor", "Portland Marathon", "http://portlandmarathon.org/", "", "No", "");
...
// //2
var runLikeHell15 = new race("Run Like Hell", "2015-10-25", 2, "half","Portland, OR", "Pioneer Courthouse Square", "Terrapin Events", "http://terrapinevents.com/event/run-like-hell-portland-half-marathon/", 5000, "Yes", "Halloween/Under the Big Top" );
...
//November 2015 Races
//3
var purpleStride15 = new race("PurpleStride Puget Sound", 3, "5k", "2015-11-01",  "Seattle, WA", "Magnuson Park - Hangar 30", "Pancreatic Cancer Action Network", "http://purplestride.kintera.org/faf/home/default.asp?ievent=1136780&lis=1&kntae1136780=1F3F5806E8AC432DA54E18145E426A6C", "", "", "");
...
//4
var runWithTheDuck15 = new race ("Run with the Duck", "2015-11-08", 4, "5k", "Eugene, OR", "Riverfront Field - south side of Autzen Footbridge", "University of Oregon: Healthy Oregon", "http://healthyoregon.uoregon.edu/Events/duckrun.aspx?q=DuckRun", "500", "", "");
...
//5
var hotButteredRun15 = new race ("Hot Buttered Run", "2015-11-29", 5, "half", "Vancouver, WA", "Esther Short Park", "Engery Events", "http://energyevents.com/hotbutteredrun", "", "", "", "Winter Holidays");
...
//December 2015 Races
//6
var hoHo15 = new race("Ho Ho 5k", "2015-12-06", 6, "5k", "Tigard, OR", "Cook Park", "X-Dog Events", "http://www.xdogevents.com/hoho.html", "", "", "Winter Holidays");
	...
	raceArr.push(hoHo15);
//7
var jingleBell15 = new race("Jingle Bell 5k", "2015-12-06", 7, "5k", "Portland, OR", "World Trade Center", "The Arthritis, Foundation", "http://www.jbr.org/faf/home/default.asp?ievent=1138292", "", "", "Winter Holidays" );
...
//8
var holidayHalf15 = new race("Holiday Half & 5k", 8, "half", "2015-12-13", "Portland, OR", "Addias North America Campus", "Foot Traffic", "http://foottraffic.us/the-races/holiday/", "", "", "Winter Holidays");
